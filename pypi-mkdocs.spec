...
Source0  : https://files.pythonhosted.org/packages/0a/93/caaf7db71f730011e583d1977bef355b9a06c21b3967395ea2f3ce73ae5b/mkdocs-1.2.3.tar.gz
...
%prep
%setup -q -n mkdocs-1.2.3
cd %{_builddir}/mkdocs-1.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641568831
...
cp %{_builddir}/mkdocs-1.2.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs/dd3c063a6e112f29876344a5bcd28dc3ee2a73bf
