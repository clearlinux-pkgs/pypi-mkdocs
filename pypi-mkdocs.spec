...
Source0  : https://files.pythonhosted.org/packages/cc/6b/26b33cc8ad54e8bc0345cddc061c2c5c23e364de0ecd97969df23f95a673/mkdocs-1.6.0.tar.gz
...
%prep
%setup -q -n mkdocs-1.6.0
cd %{_builddir}/mkdocs-1.6.0
pushd ..
cp -a mkdocs-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713665760
