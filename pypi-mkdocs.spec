...
%prep
%setup -q -n mkdocs-1.3.0
cd %{_builddir}/mkdocs-1.3.0
pushd ..
cp -a mkdocs-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656394045
...
cp %{_builddir}/mkdocs-1.3.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs/dd3c063a6e112f29876344a5bcd28dc3ee2a73bf
